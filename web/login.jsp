...
<body class="cover" style="background-image: url(Framework-Gumby/Imagenes/img/login_imagen.jpg);">
	<form action="menu.jsp" method="post" autocomplete="off" class="full-box logInForm">
		...
		<div class="form-group label-floating">
		  ...
		  <input class="form-control" name="UserEmail" id="email" type="text">
		  <p class="help-block">Escribe tú E-mail</p>
		</div>
		<div class="form-group label-floating">
		  <label class="control-label" for="UserPass">Contraseña</label>
		  <input class="form-control" name="UserPass" type="password" id="password">
		  <p class="help-block">Escribe tú contraseña</p>
		</div>
		<div class="form-group text-center">
                    <input type="submit" value="Iniciar sesión" id="submit" btn btn-raised btn-danger>
		</div>
